          ...
          <div>
            ...
            <form onSubmit={handleConsult} className="space-y-4">
              <textarea
                ...
                placeholder="Ex: I want to build a modern 3-bedroom sustainable home in the Pacific Northwest with a focus on natural lighting and energy efficiency..."
            ...
            {result && (
              <div className="space-y-8 animate-in fade-in duration-500">
                ...
                <div className="pt-8 border-t border-stone-100">
                  <button className="text-stone-900 font-bold uppercase tracking-widest text-sm flex items-center hover:text-amber-500 transition-colors">
                    Download Consultation PDF <i className="fas fa-arrow-right ml-2"></i>
                  </button>
                </div>
              </div>
            )}
